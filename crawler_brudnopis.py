...
#     services = ["cinema", "gym", "fitness", "sauna", "parking", "pool", "coffee", "library", "bicycle"]
#
#     near_school = 0
#     near_hospital = 0
...
#     near_services = 0
#
#     descriptions = offer_description_en.lower()
#     offer_description_words = descriptions.split()
